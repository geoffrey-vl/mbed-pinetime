...
SPI4Wire Peripherals::display_interface(SPI_MOSI, SPI_MISO, SPI_SCK, SPI_CS_LCD, PIN_LCD_RS_OUT);

//peripherals
ST7789LVGL Peripherals::lcd(Peripherals::display_interface, PIN_LCD_RESET_OUT);
